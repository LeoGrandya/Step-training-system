...
class Subject(db.Model):
    ...
    hand = db.Column(db.String(16), nullable=False, default="右手")
    years = db.Column(db.Integer, nullable=False, default=0)
    level = db.Column(db.String(32), nullable=False, default="业余")
...
class TrainingConfig(db.Model):
    ...
    mode = db.Column(db.String(32), nullable=False, default="练习评估", index=True)
    analysis_profile = db.Column(db.String(32), nullable=False, default="快速")
...
class KinematicsDataset(db.Model):
    ...
    subject_id = db.Column(db.String(32), db.ForeignKey("subjects.id", ondelete="CASCADE"), index=True)
    training_video_id = db.Column(db.String(32), db.ForeignKey("training_videos.id", ondelete="SET NULL"))
    report_payload_path = db.Column(db.String(512))
    chart_bundle_path = db.Column(db.String(512))
